...
public final class JsonSchemaGenerator
{
    ...
    private SchemaNode buildRouteDefinition()
    {
        ...
        final SchemaNode requireUpstream = new ObjectSchema(null, null, List.of("upstream"), null, null, null, null, null, null, null);
        final SchemaNode requireFilters = new ObjectSchema(null, null, List.of("filters"), null, null, null, null, null, null, null);
    ...
    private SchemaNode buildUpstreamSchema()
    {
        ...
        final Map<String, SchemaNode> props = Map.of(
    ...
    private SchemaNode buildJournalSchema()
    {
        ...
        final SchemaNode overridesSchema = new ObjectSchema(
                "object", null, null,
                new SchemaProps(new PrimitiveSchema("string", null, null, null, null, null, null)),
                null, null, null, null,
                "Overrides for the journal level based on specific HTTP status codes or classes (e.g., '5xx': 'FULL', '404': 'NONE').",
                null
        );

        final Map<String, SchemaNode> levelDefProps = Map.of(
                "level", levelSchema,
        ...
        return new ObjectSchema(
                "object",
                Map.of("request", levelDef, "response", levelDef),
                null,
                new BoolProps(false),
                null, null, null, null,
            ...
            final Map<String, SchemaNode> extraProperties)
    {
        ...
        ServiceLoader.load(spiClass).forEach(factory -> {
            ...
            // Extract @Description from the factory class itself
            ...
            if (configClass != null && configClass.isRecord())
            {
                ...
                {
                    SchemaNode config = buildInnerConfigSchema(configClass);

                    // Inject the description into the filter definition
