...
@Description("Matches if a request contains the specified header, regardless of its value.")
public final class HasRequestHeaderFactory implements GatewayPredicateFactory<HasRequestHeaderFactory.Config>
{
    private static final String PREDICATE_NAME = "HasRequestHeader";
    ...
    private static final class GP implements GatewayPredicate, ShortInfo
    {
        ...
        {
            return request.headers().getFirst(this.headerName) != null;
        }
