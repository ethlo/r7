...
public final class JournalExchange
{
    ...
    public JournalExchange(String reqId)
    {
        this.reqId = reqId;
    }
    ...
    public String getRequestStartLine() { return requestStartLine; }
    public Map<String, String> getRequestHeaders() { return requestHeaders; }
    public List<ByteBuffer> getRequestBodyFragments() { return requestBodyFragments; }
    public String getResponseStartLine() { return responseStartLine; }
