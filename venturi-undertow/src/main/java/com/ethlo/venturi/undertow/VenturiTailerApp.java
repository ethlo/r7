...
import com.ethlo.venturi.core.storage.mmap.ExchangeReassembler;
import com.ethlo.venturi.core.storage.mmap.VenturiTailer;
...
public class VenturiTailerApp
{
    public static void main(String[] args) throws Exception 
    {
        ...
        VenturiTailer tailer = new VenturiTailer(logDir, jsonWriter);
